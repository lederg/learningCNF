...
docker-machine ssh $1 "sudo docker run -d -v /home/ubuntu/learningCNF:/code -v /efs/runs_cadet/:/code/runs_cadet -v /home/ubuntu/synthetic_qbf_formulas:/code/data -v /efs/saved_models:/code/saved_models -v /efs/eps:/code/eps gilled/learningcnf:v5 ${@:2}"
