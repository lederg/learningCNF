...
def create_policy(settings=None, is_clone=False):
  ...
  from sat_policies import SatPolicy, SatLinearPolicy, SatMiniLinearPolicy, SatLBDPolicy, SatRandomPolicy, SatBernoulliPolicy, SatThresholdPolicy, SatFixedThresholdPolicy, SatFreeThresholdPolicy, SatHyperPlanePolicy
