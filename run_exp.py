...
def main(DS_TRAIN_FILE, DS_VALIDATION_FILE, DS_TEST_FILE, data_mode, threshold):
	...
	ns1 = CnfDataset.from_dimacs('data/train_random3_10/sat/', 'data/train_random3_10/unsat/', max_size=200)
	ns2 = CnfDataset.from_dimacs('data/validation_random3_10/sat/', 'data/validation_random3_10/unsat/', max_size=200)
